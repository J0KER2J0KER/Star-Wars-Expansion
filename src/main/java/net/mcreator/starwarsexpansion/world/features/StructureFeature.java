package net.mcreator.starwarsexpansion.world.features;
...
import net.mcreator.starwarsexpansion.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, StarWarsExpansionMod.MODID);
